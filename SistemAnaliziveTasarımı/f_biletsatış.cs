...
{
    public partial class f_biletsatış : Form
    {
        public f_biletsatış()
        {
            InitializeComponent();
        ...
        private void f_biletsatış_Load(object sender, EventArgs e)
        {
            yenidenrenklendir();
            Koltuklar();
            koltukrengi();
            ...
            lblsatış.Text = Properties.Strings.lbl_biletbilgiler;
            ...
            button2.Text = Properties.Strings.buttonyeni;
