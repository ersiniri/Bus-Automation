...
{
    public partial class f_kullanicikayıt : Form
    {
        public f_kullanicikayıt()
        {
            InitializeComponent();
        }
        ...
        private void f_kullanicikayıt_Load(object sender, EventArgs e)
        {
            ...
            lblkkayıt.Text = Properties.Strings.lbl_kullanıcıkayıt;
        }
